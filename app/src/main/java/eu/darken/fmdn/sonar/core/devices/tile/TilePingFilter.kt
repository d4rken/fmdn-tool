...
import eu.darken.fmdn.sonar.core.devices.gfd.DefaultGFDPing
...
@Reusable class TilePingFilter @Inject constructor(
    ...
    override suspend fun parse(scan: BleScanResult): TileTrackerPing? {
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: TilePingFilter): PingFilter
    }

    companion object {
        val UID_SERVICE: ParcelUuid = ParcelUuid.fromString("0000feed-0000-1000-8000-00805f9b34fb")

        private val TAG = logTag("Tracker", "Sonar", "PingFilter", "Tile")
    }
}