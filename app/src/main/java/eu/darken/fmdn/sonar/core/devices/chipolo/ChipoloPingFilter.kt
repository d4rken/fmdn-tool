...
@Reusable class ChipoloPingFilter @Inject constructor(
    ...
    override suspend fun parse(scan: BleScanResult): ChipoloTrackerPing? {
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: ChipoloPingFilter): PingFilter
    }

    companion object {
        val UID_SERVICE: ParcelUuid = ParcelUuid.fromString("0000FE33-0000-1000-8000-00805F9B34FB")

        private val TAG = logTag("Tracker", "Sonar", "PingFilter", "Chipolo")
    }
}